...
**Los tres se regeneran en disco, pero solo el de Centro de Costos se republica automáticamente** (`/Actualizar_CC`). Los de Análisis Financiero y Cotizador se publican a mano contra su link fijo — cerrar ese hueco para los tres es el siguiente paso natural de `/Actualizar_Finanzas`.
